...
/skills - выбор навыка, использованного в проекте
...
def name_project(message):
    ...
    bot.register_next_step_handler(message, des_project, data=data)
def des_project(message, data):
...
def skill_handler(message):
    ...
    bot.send_message(message.chat.id, 'Выбери проект для которого нужно выбрать навык:', reply_markup=gen_inline_markup(projects))
